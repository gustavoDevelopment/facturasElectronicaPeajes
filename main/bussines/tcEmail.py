...
def do_on_start(subFolder):
    downloadZIPS = os.path.join(os.getcwd(), "zip",str(month)+str("_")+str(year))
    processZIPS = os.path.join(os.getcwd(), "closedZip",str(month)+str("_")+str(year))   
