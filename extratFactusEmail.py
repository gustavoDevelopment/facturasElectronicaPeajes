...
DESTINO_ZIPS = os.path.join(os.getcwd(), "zip") # Ruta local para guardar
PROCESADOS_ZIPS = os.path.join(os.getcwd(), "closedZip") # Ruta local para guardar
...
def conectar_y_descargar(mes, año):
    ...
    for num in ids:
        ...
        for parte in mensaje.walk():
            ...
            if nombre_archivo and nombre_archivo.endswith(".zip"):
                ...
                ruta_completa = os.path.join(DESTINO_ZIPS, nombre_archivo)
                ruta_process = os.path.join(PROCESADOS_ZIPS, nombre_archivo)
